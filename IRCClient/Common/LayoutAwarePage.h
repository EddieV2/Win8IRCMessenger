...
namespace IRCClient
{
	namespace Common
	{
		...
		public:
			...
			property Platform::String^ SubMode
			{
				Platform::String^ get() { return m_subMode; }
				void set(Platform::String^ value) { if (value != m_subMode) { m_subMode = value; InvalidateVisualState(); } };
			}
